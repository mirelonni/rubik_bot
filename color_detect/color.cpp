...
int main(int argc, char const *argv[]) {
  ...
  map<char, Scalar> std_colors = {
    { 'r', Scalar(63.9997, 16.7637, 201.827) },
    { 'g', Scalar(67.5469, 190.459, 63.1386) },
    { 'b', Scalar(184.179, 127.687, 30.4349) },
    { 'y', Scalar(92.7966, 149.686, 172.643) },
    { 'o', Scalar(40.177, 113.433, 213.907) },
    { 'w', Scalar(180.152, 182.672, 179.323) }
  };
